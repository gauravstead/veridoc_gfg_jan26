...
import {
    ...
    Check, X, BarChart3, Fingerprint, FileType, Search
} from 'lucide-react';
...
export function ReportDashboard({ data, onReset }) {
    ...
    const renderVisualMetrics = (details) => {
        ...
        const varScore = Math.max(0, 100 - ((details.variance?.average_diff || 0) * 10)); // Arbitrary scaling for variance
                ...
                <div className="lg:col-span-8 space-y-6">
                            ...
                            <div className="flex items-center gap-5">
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 text-sm font-medium mt-1">
                                        ...
                                        <span className="text-slate-500">Gemini 2.5 Flash Forensic Verdict</span>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                        <div className="px-6 py-4 border-b border-slate-100 flex items-center gap-2">
                            ...
                            <h3 className="font-semibold text-slate-800">Forensic Metrics Breakdown</h3>
                        </div>
                        <div className="p-6">
                        ...
                        <div className="space-y-6 relative">
                            ...
                            <div className="flex gap-4 relative">
                                ...
                                <div>
                                    ...
                                    <p className="font-semibold text-slate-800">Gemini 2.5 Flash</p>
                                </div>
                            </div>
